...
export default function PromoSection() {
  const promos = [
    {
      ...
      badge: '-30%',
      icon: <Zap className="w-12 h-12 text-neon" />,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      badge: 'Gratis',
      icon: <Gift className="w-12 h-12 text-neon" />,
    },
  ];
  ...
  return (
    <section id="promociones" className="py-24 relative">
      {/* Fondo */}
      <div className="absolute inset-0 bg-gradient-to-b from-base via-card/30 to-base"></div>

      <div className="max-w-7xl mx-auto px-4 relative z-10">
        {/* Encabezado */}
        <div className="text-center mb-16">
          <span className="text-muted text-sm font-mono mb-4 block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {promos.map((promo) => (
            ...
            >
              {/* Badge */}
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-neon to-green-500 rounded-full flex items-center justify-center font-bold text-base text-lg shadow-lg shadow-neon/50 transform group-hover:scale-110 transition">
                {promo.badge}
              </div>
              ...
              {/* Contenido */}
              <h3 className="text-2xl font-black mb-2 text-white group-hover:glow-text transition">
                {promo.title}
              </h3>
